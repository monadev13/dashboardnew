@extends('layouts.master')
  ...
  <!-- Data table CSS -->
	...
	<!-- switchery CSS -->
	<link href="{{asset('assets/admin/vendors/bower_components/switchery/dist/switchery.min.css')}}"  type="text/css"/>
	
	<!-- vector map CSS -->
	<link href="{{asset('assets/admin/vendors/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
...
@section('content')
    ...
    <script src="{{asset('assets/admin/vendors/vectormap/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{asset('assets/admin/vendors/vectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
	<script src="{asset('assets/admin/dist/js/vectormap-data.js')}}"></script>
	...
	<script src="{asset('assets/admin/dist/js/flot-data.js')}}"></script>
	...
	<script src="{asset('assets/admin/dist/js/dashboard2-data.js')}}"></script>
