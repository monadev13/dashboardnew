@extends('layouts.master')
  ...
  @endsection
    <!-- vector map CSS -->
		<link href="{{asset('assets/admin/vendors/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" type="text/css"/>
		
		<!-- Footable CSS -->
		<link href="{{asset('assets/admin/vendors/bower_components/FooTable/compiled/footable.bootstrap.min.css')}}" rel="stylesheet" type="text/css"/>
  @section('css')
  @endsection
@section('content')
...
@section('js')  
		...
		<script src="{{asset('assets/admin/vendors/bower_components/FooTable/compiled/footable.min.js')}}" type="text/javascript"></script>
		<script src="{{asset('assets/admin/dist/js/footable-data.js')}}"></script>
    @endsection
